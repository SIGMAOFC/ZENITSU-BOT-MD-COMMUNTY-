...
➤• BOT VERSION : 3.5
➤• DONO : ALEMAO
➤• OBRIGADO POR USAR O BOT DE ZENITSU
➤• COMMUNITY ZENITSU BOT MD
➤• COMMUNITY ALEMAO DEVS
|< ================================================== >|`), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
/*const banner2 = cfonts.render(('BEY ALEMÃO'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
colors: [`${cor3}`,`${cor1}`,`${cor5}`],
...
const banner3 = cfonts.render((`ZENITSU MD 3.5`), {
font: 'tiny',             
align: 'center',           
